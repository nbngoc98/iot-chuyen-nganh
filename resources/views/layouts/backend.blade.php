...
<html lang="{{ config('app.locale') }}" class="no-focus">
    <head>
        {{--  <base href="{{ asset('') }}">  --}}
        <base href="https://nbngoc98.azurewebsites.net/public/">
        <meta charset="utf-8">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                <a class="link-effect font-w700" href="/">
                                    ...
                                    <span class="font-size-xl text-dual-primary-dark">Smart</span><span class="font-size-xl text-primary">irrigation</span>
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <ul class="list-inline mt-10">
                                <li class="list-inline-item">
                                    <a class="link-effect text-dual-primary-dark font-size-sm font-w600 text-uppercase" href="javascript:void(0)">ADMIN</a>
                                </li>
                                <li class="list-inline-item">
                                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-visible">MR</span><span class="sidebar-mini-hidden">Quản lý hệ thống</span>
                            </li>
                            <li>
                                <a href="{{ route('view-hethong') }}">
                                    <i class="si si-globe"></i><span class="sidebar-mini-hide">Quản lý thông số</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('setting-hethong') }}">
                                    <i class="si si-globe"></i><span class="sidebar-mini-hide">Chức năng hệ hống</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-sm clearfix">
                    <div class="float-right">
                        HỆ THỐNG TƯỚI CÂY TỰ ĐỘNG <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href=" target="_blank">Nguyễn Bảo Ngọc</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="" target="_blank">Smart irrigation</a> &copy; <span class="js-year-copy"></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
